...
public class DesignatorWithActPars extends DesignatorFunctionCall {

    private Designator Designator;
    private OptionalActPars OptionalActPars;

    public DesignatorWithActPars (Designator Designator, OptionalActPars OptionalActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorWithActPars(\n");
